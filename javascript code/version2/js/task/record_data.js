...
function Data_row(obj) {
    ...
    this.image_scene = "NA";
    this.cue_color = "NA";
    this.rule_labels_left = "NA";
    this.rule_labels_right = "NA";

    this.flanker_img = "NA";

    this.target_word = "NA";
    this.target_scene = "NA";
    this.lure_word = "NA";
    this.lure_scene = "NA";
    this.trial_img = "NA";
...
function create_form() {
    let formHTML = [
            "<form id='sendtoPHP' method='post' action='https://dibs-web01.vm.duke.edu/AMTSubmit/DataHandler_TW.php'' style='display: none'>",
                ...
                "<input type='hidden' name='experiment-name' id = 'experiment-name' value='TaskSwitching_Memory' />",
            "</form>"
...
function submit_data() {
    ...
    data = data.concat(ts_attn.trials)
    data = data.concat(ts_flanker.f_trials)
    data = data.concat(ts_memory_reward.mem_trials)
