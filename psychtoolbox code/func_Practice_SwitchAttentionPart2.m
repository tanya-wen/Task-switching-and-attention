function overall_accuracy = func_Practice_SwitchAttentionPart2(windowPtr,rect,run_number,SubjID)
...
save(strcat('C:/Users/egnerlab/Desktop/Tanya/task switching and attention/psychtoolbox code/February_2020_Version/data/Practice_SwitchAttnMemPart2_',SubjID,'_Practice_','Run',num2str(run_number),'_',time,'.mat'));
